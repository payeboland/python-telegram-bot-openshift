...
def maker2(name,phone,desc):
    ...
    draw.text((5, img.height-30),disp,(255,255,255),font=font)
    ...
    draw.text((img.width / 2 -8*len(name) , img.height/2 - 125),namedisp,(255,255,255),font=font)
    ...
    draw.text((img.width / 2 -5*len(desc) , img.height/2 -20),descdisp,(255,255,255),font=font)
